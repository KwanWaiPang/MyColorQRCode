 ...
 */
public class BlueScanningAnalyzer implements Analyzer<List<String>> {
     ...
     */
    public BlueScanningAnalyzer(boolean isOutputVertices) {
...
//                    int red = Color.red(pixel);
                    ...
                    int newPixel = Color.rgb(0, 0, Blue);
