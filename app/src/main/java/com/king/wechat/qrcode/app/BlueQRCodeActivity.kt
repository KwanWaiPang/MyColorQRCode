...
import com.king.wechat.qrcode.scanning.analyze.BlueScanningAnalyzer
 ...
 */
class BlueQRCodeActivity : WeChatCameraScanActivity() {
    ...
    override fun onScanResultCallback(result: AnalyzeResult<List<String>>) {
        ...
        if (result is BlueScanningAnalyzer.QRCodeAnalyzeResult) { // 如果需要处理结果二维码的位置信息
...
//        return WeChatScanningAnalyzer()
        ...
        return BlueScanningAnalyzer(true)
    }
