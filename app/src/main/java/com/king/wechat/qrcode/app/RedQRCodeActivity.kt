...
import com.king.wechat.qrcode.scanning.analyze.RedScanningAnalyzer
 ...
 */
class RedQRCodeActivity : WeChatCameraScanActivity() {
    ...
    override fun onScanResultCallback(result: AnalyzeResult<List<String>>) {
        ...
        if (result is RedScanningAnalyzer.QRCodeAnalyzeResult) { // 如果需要处理结果二维码的位置信息
...
//        return WeChatScanningAnalyzer()
        ...
        return RedScanningAnalyzer(true)
    }
