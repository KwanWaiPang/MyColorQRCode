...
import com.king.wechat.qrcode.scanning.analyze.GreenScanningAnalyzer
 ...
 */
class GreenQRCodeActivity : WeChatCameraScanActivity() {
    ...
    override fun onScanResultCallback(result: AnalyzeResult<List<String>>) {
        ...
        if (result is GreenScanningAnalyzer.QRCodeAnalyzeResult) { // 如果需要处理结果二维码的位置信息
...
//        return WeChatScanningAnalyzer()
        ...
        return GreenScanningAnalyzer(true)
    }
